...
void do_lss(void);
void do_manual(void);
void do_manual_list(void);
void do_map(void);
void do_max(void);
void do_maxint(void);
void do_memoryindex(void);
void do_memorymax(void);
void do_min(void);
void do_mktime(void);
void do_mod(void);
void do_modf(void);
...
void do_setlisting(void);
void do_setsize(void);
void do_setstats(void);
void do_settrace(void);
void do_settracegc(void);
...
void do_swapd(void);
void do_swons(void);
void do_symtabindex(void);
void do_symtabmax(void);
void do_system(void);
...
void is_user(long);
void is_logical(long);
void is_char(long);
void is_integer(long);
void is_set(long);
void is_string(long);
void is_list(long);
void is_float(long);
